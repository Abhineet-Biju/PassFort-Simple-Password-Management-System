...
def first_time_window():
    ...
    entry2 = ctk.CTkEntry(root, width=150)
    entry2.pack()
...
def login_window():
    ...
    entry = ctk.CTkEntry(root, width=150, show='#')
    entry.pack()
    entry.focus()
